      ...
      <div className="main-wrapper" style={{ flex: 1, marginLeft: "260px" }}>
        ...
        <main className="main-content" style={{ padding: "20px" }}>
          <Routes>
            ...
            <Route
              path="/profile"
              element={<ProfilePage userData={currentUser} />}
            />
            <Route
              path="/edit-profile"
              element={<EditProfilePage userData={currentUser} />}
            />
            <Route
              path="/worker-profile/:id"
              element={<WorkerPage userData={currentUser} />}
            />
            {/* */}
            <Route
              path="/client-profile/:id"
              element={<Client userData={currentUser} />}
            />
            {/* */}
          ...
          <Route path="/login-worker" element={<LogInWorker onLogin={() => handleLogin('worker')} />} /> */}
            <Route
              path="login-client"
              element={
                <LogInClient onLogin={() => setCurrentUser(clientData)} />
              }
            />
            <Route
              path="/login-worker"
              element={
                <LogInWorker onLogin={() => setCurrentUser(workerData)} />
              }
            />
          ...
          <Route path="/client-home" element={<ClientHomePage/>}/> */}
            ...
            <Route
              path="/workers/:serviceName"
              element={<ServiceWorkersPage />}
            />
          </Routes>
        </main>
      </div>
...
export default App;
>>>>>>> a84e2819f3a37889351d291913a864bccd970775
